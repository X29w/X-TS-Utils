 ...
 * 指定请求数据类型归类
 */
export const EasyAxiosRequestQueryParamsMethod = <Base.RequestConfigMethod>(
  'GET'
);
export const EasyAxiosRequestDataMethods = <Base.RequestConfigMethod[]>[
  'POST',
  'PUT',
  'DELETE',
  'HEAD',
 ...
 * 下载模式响应体默认结构
 */
export const EasyAxiosDownloadResponseDefaultContent = <
  Base.IStreamingDownloadResponse
>{
  code: 200,
  message: '下载成功',
};
 ...
 */
export const useAxiosDefaultRequestConfig = (
  qs?: any,
